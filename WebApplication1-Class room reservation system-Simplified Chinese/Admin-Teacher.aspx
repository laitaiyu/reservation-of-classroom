...
<HeaderTemplate>
          <Asp:Table ID="Table1" Runat="Server" Width="600">
            <Asp:TableRow ID="TableRow1" Runat="Server">
              <Asp:TableCell ID="TableCell1" Runat="Server" Width="50" Font-Size="10pt">
                自动编号
              </Asp:TableCell>
              <Asp:TableCell ID="TableCell2" Runat="Server" Width="50" Font-Size="10pt">
                姓名
              </Asp:TableCell>
              <Asp:TableCell ID="TableCell3" Runat="Server" Width="50" Font-Size="10pt">
                联络电话
              </Asp:TableCell>
              <Asp:TableCell ID="TableCell4" Runat="Server" Width="50" Font-Size="10pt">
                移动电话
              </Asp:TableCell>
              <Asp:TableCell ID="TableCell5" Runat="Server" Width="100" Font-Size="10pt">
                通讯地址
              </Asp:TableCell>
              <Asp:TableCell ID="TableCell6" Runat="Server" Width="50" Font-Size="10pt">
                账号
              </Asp:TableCell>
              <Asp:TableCell ID="TableCell7" Runat="Server" Width="50" Font-Size="10pt">
                密码
              </Asp:TableCell>
              <Asp:TableCell ID="TableCell8" Runat="Server" Width="80" Font-Size="10pt">
                功能
              </Asp:TableCell>
            </Asp:TableRow>
          </Asp:Table>
...
<Asp:Table id="Table1" Runat="server" Width="600">
            <Asp:TableRow ID="TableRow2" Runat="Server" HorizontalAlign="Center">
              <Asp:TableCell ID="TableCell9" Runat="Server" Width="50" Font-Size="10pt">
                <%# Container.DataItem("T-ID") %>
              </Asp:TableCell>
              <Asp:TableCell ID="TableCell10" Runat="Server" Width="50" Font-Size="10pt">
                <%# Container.DataItem("T-Name_FN_CHT") %>
              </Asp:TableCell>
              <Asp:TableCell ID="TableCell11" Runat="Server" Width="50" Font-Size="10pt">
                <%# Container.DataItem("T-Tel_Home") %>
              </Asp:TableCell>
              <Asp:TableCell ID="TableCell12" Runat="Server" Width="50" Font-Size="10pt">
                <%# Container.DataItem("T-Tel_Cellphone") %>
              </Asp:TableCell>
              <Asp:TableCell ID="TableCell13" Runat="Server" Width="100" Font-Size="10pt">
                <%# Container.DataItem("T-ADD_1") %>
              </Asp:TableCell>
              <Asp:TableCell ID="TableCell14" Runat="Server" Width="50" Font-Size="10pt">
                <%# Container.DataItem("T-LN") %>
              </Asp:TableCell>
              <Asp:TableCell ID="TableCell15" Runat="Server" Width="50" Font-Size="10pt">
                <%# Container.DataItem("T-PW") %>
              </Asp:TableCell>
              <Asp:TableCell ID="TableCell16" Runat="Server" Width="80" Font-Size="10pt">
...
<Asp:Table id="Table2" Runat="server" Width="600">
            <Asp:TableRow ID="TableRow3" Runat="Server" HorizontalAlign="Center">
              <Asp:TableCell ID="TableCell17" Runat="Server" Width="50" Font-Size="10pt">
                <%# Container.DataItem("T-ID") %>
              </Asp:TableCell>
              <Asp:TableCell ID="TableCell18" Runat="Server" Width="50" Font-Size="10pt">
                <Asp:TextBox Runat="Server" Id="txtET_Name" Width="50" Text='<%# Container.DataItem("T-Name_FN_CHT") %>' Font-Size="10pt"/>
              </Asp:TableCell>
              <Asp:TableCell ID="TableCell19" Runat="Server" Width="50" Font-Size="10pt">
                <Asp:TextBox Runat="Server" Id="txtET_Tel_Home" Width="50" Text='<%# Container.DataItem("T-TEL_Home") %>' Font-Size="10pt"/>
              </Asp:TableCell>
              <Asp:TableCell ID="TableCell20" Runat="Server" Width="50" Font-Size="10pt">
                <Asp:TextBox Runat="Server" Id="txtET_Tel_Cellphone" Width="50" Text='<%# Container.DataItem("T-TEL_Cellphone") %>' Font-Size="10pt"/>
              </Asp:TableCell>
              <Asp:TableCell ID="TableCell21" Runat="Server" Width="100" Font-Size="10pt">
                <Asp:TextBox Runat="Server" Id="txtET_ADD_1" Width="100" Text='<%# Container.DataItem("T-ADD_1") %>' Font-Size="10pt"/>
              </Asp:TableCell>
              <Asp:TableCell ID="TableCell22" Runat="Server" Width="50" Font-Size="10pt">
                <Asp:TextBox Runat="Server" Id="txtET_LN" Width="50" Text='<%# Container.DataItem("T-LN") %>' Font-Size="10pt"/>
              </Asp:TableCell>
              <Asp:TableCell ID="TableCell23" Runat="Server" Width="50" Font-Size="10pt">
                <Asp:TextBox Runat="Server" Id="txtET_PW" Width="50" Text='<%# Container.DataItem("T-PW") %>' Font-Size="10pt"/>
              </Asp:TableCell>
              <Asp:TableCell ID="TableCell24" Runat="Server" Width="100" Font-Size="10pt">
                <Asp:LinkButton ID="LinkButton2" Runat="Server" Width="18" Text="更新" CommandName="Update" Font-Size="10pt"/>
              　<Asp:LinkButton ID="LinkButton3" Runat="Server" Width="18" Text="删除" CommandName="Delete" Font-Size="10pt"/>
              　<Asp:LinkButton ID="LinkButton4" Runat="Server" Width="18" Text="取消" CommandName="Cancel" Font-Size="10pt"/>
              </Asp:TableCell>
            </Asp:TableRow>
          </Asp:Table>
</EditItemTemplate>
