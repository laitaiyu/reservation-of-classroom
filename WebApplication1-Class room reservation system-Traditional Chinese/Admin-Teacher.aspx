...
<Asp:Table id="Table2" Runat="server" Width="600">
            <Asp:TableRow Runat="Server" HorizontalAlign="Center">
              ...
              <Asp:TableCell Runat="Server" Width="100" Font-Size="10pt">
                <Asp:LinkButton Runat="Server" Width="18" Text="更新" CommandName="Update" Font-Size="10pt"/>
              　<Asp:LinkButton Runat="Server" Width="18" Text="刪除" CommandName="Delete" Font-Size="10pt"/>
              　<Asp:LinkButton Runat="Server" Width="18" Text="取消" CommandName="Cancel" Font-Size="10pt"/>
              </Asp:TableCell>
            </Asp:TableRow>
          </Asp:Table>
</EditItemTemplate>
      ...
      <asp:Label id="Label1" style="Z-INDEX: 104; LEFT: 208px; POSITION: absolute; TOP: 12px" 
                 Width="136px" runat="server" Font-Bold="True" Height="36px" Font-Size="X-Large">教　　師</asp:Label>
    </form>
  </BODY>
</HTML>
