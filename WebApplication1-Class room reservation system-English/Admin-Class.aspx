<%@ Page CodeBehind="Admin-Class.aspx.vb" Language="vb" AutoEventWireup="True" Inherits="WebApplication1.Admin_Class" %>
...
<HTML>
  ...
  Sub BindList()
      Dim strSQL As String = "Select * From [Class]"
      myDataList.DataSource = CreateDataSet(strSQL, "./DB/order.mdb", "[Class]")
      myDataList.DataBind()
  End Sub
  ...
  Sub DataList_DeleteCommand(sender As Object, e As DataListCommandEventArgs)
    Dim strSQL As String = "Delete From [Class] Where [" & _
  ...
  Sub DataList_UpdateCommand(sender As Object, e As DataListCommandEventArgs)
    Dim strClass As String = Ctype(e.Item.FindControl("txtClass"), TextBox).Text
    Dim UpdateDate As DateTime = DateTime.Now.Date()
    Dim strSQL As String = "Update [Class] Set [C-Name]='" & strClass & "' " & _
  ...
  Sub Class_Insert (sender As Object, e As Eventargs)
    If txtClass_Insert.Text = "" Then Exit Sub
    Dim strSQL As String = "Insert Into [Class] ([C-Name]) Values ('" & txtClass_Insert.Text & "')"
    ExecuteSQL(strSQL)
    txtClass_Insert.Text = ""
    BindList()
  End Sub
		</Script>
	</HEAD>
	<Body MS_POSITIONING="GridLayout" background="./image/admin-bg.gif">
		<form id="Form1" method="post" runat="server">
			<Asp:DataList Runat="Server" Id="myDataList" CellPadding="3" Width="489px" HorizontalAlign="Center"
				...
				OnCancelCommand="DataList_CancelCommand" DataKeyField="C-ID" ExtractTemplateRows="True" BorderColor="#DEBA84"
				...
				<EditItemTemplate>
					<Asp:Table Runat="Server" Width="400">
						<Asp:TableRow Runat="Server" HorizontalAlign="Center">
							...
							<Asp:TableCell Runat="Server" Width="200">
								<Asp:TextBox Runat="Server" Id="txtClass" Width="200" Text='<%# Container.DataItem("C-Name") %>' />
							</Asp:TableCell>
							<Asp:TableCell Runat="Server" Width="130">
			...
			<asp:Label id="Label2" style="Z-INDEX: 102; LEFT: 76px; POSITION: absolute; TOP: 72px" Width="82px"
				runat="server" Height="24px">Office</asp:Label>
			<asp:TextBox id="txtClass_Insert" style="Z-INDEX: 103; LEFT: 164px; POSITION: absolute; TOP: 72px"
				Width="232px" runat="server"></asp:TextBox>
			<asp:Button id="btnClass_Insert" style="Z-INDEX: 104; LEFT: 404px; POSITION: absolute; TOP: 72px"
				Width="72px" runat="server" Height="24px" Text="Add" OnClick="Class_Insert"></asp:Button>
			<asp:Label id="Label1" style="Z-INDEX: 105; LEFT: 208px; POSITION: absolute; TOP: 12px" Width="136px"
				runat="server" Font-Bold="True" Height="36px" Font-Size="X-Large">Office</asp:Label>
		</form>
	</Body>
</HTML>
